...
<head>
    ...
    <title>About Us - Car Service & Repair HTML5 Template</title>
...
<!-- Page Header End !--><!-- About Us Area Start -->
<div class="about-us-page te-py-120">
    <div class="container">
        <div class="row gy-5">
                    ...
                    <div class="te-main-img-wrapper">
                        <div class="te-main-img-inner">
                            <div class="about-img-one">
                                <img class="tilt-animate" src="images/about/about-1.jpg" alt="about card img">
                                <div class="about-img-two">
                                    <img class="tilt-animate" src="images/about/about-2.jpg" alt="about card shape image" />
                                </div>
                            </div>
                            <div class="te-company-foundation-wrapper">
                                <div class="te-company-foundation">
                                    <div class="te-company-experience">
                                        <div class="icon">
...
<div class="brand-slider-area style-1 background-red" style="background-image: url('images/section-bg/brand-slider-bg.png')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 offset-xl-4 align-self-center">
                <div class="te-about-info-card background-black" style="background-image: url('images/section-bg/about-bg.png')">
...
<div class="te-process-step-area style-2 te-py-120">
    <div class="container">
        <div class="row">
            <div class="col-12">
