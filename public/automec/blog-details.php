...
<head>
    ...
    <title>Blog Details - Car Service & Repair HTML5 Template</title>
                                ...
                                <div class="row gy-4 mb-4">
                                    <div class="col-md-6">
                                        <div class="blog-gallery">
                                            <img class="rounded" src="images/blog-detail/b-gallery-one.jpg" alt="image">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="blog-gallery">
                                            <img class="rounded" src="images/blog-detail/b-gallery-two.jpg" alt="image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="te-author-text">
                            <div class="te-post-author-info">
                                <div class="te-author-thumb">
                                    <a href="#"><img alt="" src="images/blog/avatar.jpg" class="avatar" height="120"
                                            width="120"></a>
                                </div>
