...
<head>
    ...
    <title>Team Details - Car Service & Repair HTML5 Template</title>
                            ...
                            <div class="te-header-top-wrapper">
                                <div class="header-top-info">
                                    <div class="te-header-contact-info">
                                        ...
                                        <span><i class="fa-solid fa-location-dot"></i>6391 Elgin Rt.Mirpur, 10299</span>
    ...
    <ul>
        ...
        <li><a href="contact.php">Contact</a></li>
                            ...
                            <div class="te-header-btn">
                                ...
                                <a href="#" class="te-quote-btn">GET A QUOTE<i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                            <!-- Header Button Start !-->
...
<!-- Page Header End !--><!-- Team Details Page Start !-->
<div class="team-details-page">
    <div class="container">
        <div class="row gy-5">
            ...
            <div class="col-lg-7 order-2 order-lg-1">
                <div class="team-details-wrapper">
                    <div class="team-details">
                        <div class="content">
                            <div class="user-meta">
                                <h3 class="title">Donrilos Starmina</h3>
                                <p class="desc">Engine Master</p>
                            </div>
                            <p class="te-short-desc">Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra .Aliquam eros justo, posuere lobortis, viverra laoreet augue mattis fermentum ullamcorper viverra laoreet Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra Aliquam</p>
                            <div class="team-member-info">
                                <div class="te-single-meta">
                                    <span class="meta-title">Phone :</span>
                                    <span class="meta-text">(405) 555-0128</span>
                                </div>
                                <div class="te-single-meta">
                                    <span class="meta-title">Email :</span>
                                    <span class="meta-text">yourmail@gmail.com</span>
                                </div>
                                <div class="te-single-meta">
                                    <span class="meta-title">Experience :</span>
                                    <span class="meta-text">10+ Years</span>
                                </div>
                                <div class="te-single-meta">
                                    <span class="meta-title">Address :</span>
                                    <span class="meta-text">Manchester, Kentucky 39495</span>
                                </div>
                                <div class="te-single-meta">
                                        <span class="meta-title">Rating :
                                            <span class="client-reviews">
                    ...
                    <div class="team-details-overview-wrapper">
                        <div class="team-details-overview">
                            <div class="content">
                                <h3 class="sec-title">Technical Experience</h3>
                                <p>Eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra .Aliquam eros just posuere lobortis, viverra laoreet augue mattis fermentum ullamcorper viverra laoreet Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra</p>
                                <p>Eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra .Aliquam eros justo, posue lobortis, viverra laoreet augue mattis fermentum ullamcorper viverra laoreet Aliquam eros justo, posuere loborti viverra laoreet </p>
                            </div>
                            <div class="skill-progressbar-content">
                                <h3 class="sec-title">Skills</h3>
                                <div class="skill-progressbar-wrapper">
                                    <div class="skill-progressbar">
                                        <div class="progress-inner" data-percentage="70%">
                                            <h4 class="progress-inner-item">
                                                <span class="skill-title">Certified Auto Technicians</span>
                                    ...
                                    <div class="skill-progressbar">
                                        <div class="progress-inner" data-percentage="50%">
                                            <h4 class="progress-inner-item">
                                                <span class="skill-title">Engine Repair Specialists</span>
                                                <span class="progressbar-number">
                                                <span class="progress-number-count">
                                                    <span class="progress-percent"></span>
                                                </span>
                                    ...
                                    <div class="skill-progressbar">
                                        <div class="progress-inner" data-percentage="60%">
                                            <h4 class="progress-inner-item">
                                                <span class="skill-title">Tire & Wheel Alignment Experts</span>
                                                <span class="progressbar-number">
                                                <span class="progress-number-count">
                                                    <span class="progress-percent"></span>
                                                </span>
                                    ...
                                    <div class="skill-progressbar">
                                        <div class="progress-inner" data-percentage="90%">
                                            <h4 class="progress-inner-item">
                                                <span class="skill-title">Vehicle Diagnostic Professionals</span>
                                                <span class="progressbar-number">
                                                <span class="progress-number-count">
                                                    <span class="progress-percent"></span>
                                                </span>
            ...
            <div class="col-lg-4 offset-xxl-1 order-1 order-lg-2">
                <div class="team-member-info-wrapper">
                    <div class="user-image">
                        <img src="images/team-member/team-details.jpg" alt="Image"/>
                    </div>
                    <div class="team-working-wrapper">
                        <h4 class="working-title">Working Hour</h4>

                        <div class="team-working">
                            <div class="single-working-slot">
                                <span class="title">Monday</span>
                                <span class="divider"></span>
                                <span class="title">2:00 AM-7.00 PM</span>
                            </div>
                            <div class="single-working-slot">
                                <span class="title">Tuesday</span>
                                <span class="divider"></span>
                                <span class="title">3:00AM -7.00 PM</span>
                            </div>
                            <div class="single-working-slot">
                                <span class="title">Friday</span>
                                <span class="divider"></span>
                                <span class="title">1:00 AM-7.00 PM</span>
                            </div>
                            <div class="single-working-slot">
                                <span class="title">Saturday</span>
                                <span class="divider"></span>
                                <span class="title">3:00 PM-6.00 PM</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="te-footer-widget">
                        <div class="te-footer-widget-info">
                            <div class="te-footer-logo">
                                <a href="index.php"><img src="images/logo/footer-logo-white.png" alt="Footer Logo"></a>
                            </div>
                            <p>Lorem Ipsum is simply is dumiomy is text Lorem Ipsum is simply  Ipsum is simply is dumiomy is text </p>
            ...
            <div class="te-menu-sidebar-content">
                <div class="te-menu-sidebar-single-widget">
                    <div class="about-info text-white">
                        <p>Tempor turpis nisl dui ut facilisi tempus at dew euismod. Lacinia facilisis ullamcorper tellus wai netus rutrum cras venenatis </p>
                    </div>
                </div>
                <div class="te-menu-sidebar-single-widget">
...
<!-- Scroll Up Section End --><script src="js/jquery.min.js"></script>
