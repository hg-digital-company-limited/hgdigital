...
<head>
    ...
    <title>Service Details - Car Service & Repair HTML5 Template</title>
                    ...
                    <div class="row gy-4 mt-3">
                        <div class="col-md-6">
                            <div class="gallery-wrapper">
                                <img class="rounded" src="images/service/gallery-one.jpg" alt="Image"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="gallery-wrapper">
                                <img class="rounded" src="images/service/gallery-two.jpg" alt="Image"/>
                            </div>
                        </div>
                    </div>
