                                    ...
                                    <div class="slider-feature">
                                        <div class="single-slider-feature">
                                            ...
                                            <div class="slider-feature-img">
                                                <img src="/automec/images/slider/feature-icon-1.png" alt="icon">
                                            </div>
                                        </div>
                                        <div class="single-slider-feature">
                                            <div class="slider-feature-content">
                                            ...
                                            <div class="slider-feature-img">
                                                <img src="/automec/images/slider/feature-icon-2.png" alt="icon">
                                            </div>
                                        </div>
                                        <div class="single-slider-feature">
                                            <div class="slider-feature-content">
                                            ...
                                            <div class="slider-feature-img">
                                                <img src="/automec/images/slider/feature-icon-3.png" alt="icon">
                                            </div>
                                        </div>
                                        <div class="single-slider-feature">
                                            <div class="slider-feature-content">
                                            ...
                                            <div class="slider-feature-img">
                                                <img src="/automec/images/slider/feature-icon-4.png" alt="icon">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="slick-item">
                    <div class="client-logo-wrapper">
                        <div class="client-logo">
                            <img src="/automec/images/brand-logo/client-4.png" alt="logo" />
                        </div>
                    </div>
                </div>
                <div class="slick-item">
                    <div class="client-logo-wrapper">
                        <div class="client-logo">
                            <img src="/automec/images/brand-logo/client-5.png" alt="logo" />
                        </div>
                    </div>
                </div>
                <div class="slick-item">
            ...
            <div class="row gy-5">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="te-process-step">
                        <div class="icon">
                            <img src="/automec/images/icon/process/icon-1.png" alt="Icon">
                        </div>
                        <div class="te-content-wrapper">
                            <div class="te-title-wrapper">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="te-process-step">
                        <div class="icon">
                            <img src="/automec/images/icon/process/icon-2.png" alt="Icon">
                        </div>
                        <div class="te-content-wrapper">
                            <div class="te-title-wrapper">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="te-process-step">
                        <div class="icon">
                            <img src="/automec/images/icon/process/icon-3.png" alt="Icon">
                        </div>
                        <div class="te-content-wrapper">
                            <div class="te-title-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="te-section-title left-align-title">
                        <div class="te-section-content">
                            <div class="short-title-wrapper">
                                <span class="short-title only-divider">Blog Mới Nhất</span>
                            </div>
                            <h2 class="title">Bài Viết Gần Đây <br /> HG DIGITAL</h2>
                        </div>
                        <div class="te-section-desc">
                            <div class="te-theme-btn-wrapper">
                                <a wire:navigate href="{{ route('blogs') }}" class="te-theme-btn style-2">XEM THÊM <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="content">
                                <div class="te-post-meta-info">
                                    <div class="te-single-meta">
                                        ...
                                        <span class="text">By Admin</span> <!-- Thay đổi tên tác giả nếu có -->
                                    </div>
                                    <div class="te-single-meta">
                                        <span class="icon">
                                ...
                                <h3 class="title">
                                    <a wire:navigate href="{{ route('blog', $blog->slug) }}">{{ Str::limit($blog->title, 50) }}</a> <!-- Liên kết đến trang chi tiết blog -->


                                </h3>
                                <div class="te-post-content">
                                <p>{{ Str::limit($blog->short_desc, 100) }}</p> <!-- Giới hạn nội dung -->

                                </div>
                            </div>
                            <div class="btn-wrapper">
                                <a  wire:navigate href="{{ route('blog', $blog->slug) }}" class="te-theme-btn">ĐỌC TIẾP <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="image">
                            <img src="{{ Storage::url($blog->banner)  }}" alt="{{ $blog->title }}" /> <!-- Thay đổi đường dẫn hình ảnh -->
                            <div class="te-post-date">
                                <span>{{ $blog->created_at->format('d') }}</span> <!-- Ngày -->
                                <span>{{ $blog->created_at->format('F') }}</span> <!-- Tháng -->
                            </div>
                        </div>
                    </div>
                </div>
